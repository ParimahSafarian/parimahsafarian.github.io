...
if (heroTitle) {
    const text = "Hi, I'm Parimah Safarian";
    heroTitle.innerHTML = 'Hi, I\'m <span class="highlight">Parimah Safarian</span>';
    
    // Optional: Add a subtle fade-in animation instead of typing
    heroTitle.style.opacity = '0';
    heroTitle.style.transform = 'translateY(20px)';
    
    // Start fade-in animation when page loads
